...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    clientString.toCharArray(clientBuffer, clientString.length() + 1);
    if (client.connect(panelId, user, password, willTopic, willQoS, willRetain, willMessage)) {
